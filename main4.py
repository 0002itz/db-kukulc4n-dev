...
def get_real_db(username):
    conn = getConectDB()
    c = conn.cursor()
    
    user_data_query = "SELECT userNickname,Email,pw FROM Users WHERE userNickname=?"
    c.execute(user_data_query, (username,))
    user_data_query = c.fetchone()
    c.close()
...
def get_user(username: str):
    conn = getConectDB()
    c = conn.cursor()
    user_query = "SELECT userNickname,pw FROM Users WHERE userNickname=?"
